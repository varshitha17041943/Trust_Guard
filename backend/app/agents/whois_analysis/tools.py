...
def execute_tools(input_data):
    ...
    try:
        resp = requests.post("http://localhost:8001/execute", headers={"x-api-key": "internal_mcp_key", "Content-Type": "application/json"}, json={"tool": "whois_lookup", "args": {"url": input_data.url}})
